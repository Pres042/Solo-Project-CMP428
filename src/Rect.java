...
public class Rect
{
	...
	{
		return (x + w >= r.x      ) &&		// is rect 1 right most edge entering rect 2 left side 	
			   (x     <= r.x + r.w) &&		// is rect 1 left most edge entering rect 2 from right side
			   (y + h >= r.y      ) &&		// is rect 1 bottom touching the top of rect 2	   
			   (y     <= r.y + r.h);		// is rect 1 top touching the bottom of rect3
	}
